...
个人认为核心价值在于**技术栈无关**。由于历史原因，前端框架还是比较多的，`jQuery`, `Angular`, `React`, `Vue`，他们都有过大规模的应用，但是都不能保证谁笑到最后。不管是一个老项目，还是一个新项目，都需要考虑长远维护的问题，需要保证这套方案在 3 ～ 5 年还有生命力，但是目前很多前端框架/库有的也有过破坏性的更新，难以保证一年后，把所有依赖包都更新到最新版本还能正常运行。
